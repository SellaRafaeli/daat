...
exports.update = function(req, callback) {
    ...
    update_question(req, title, text, category_id, sub_category_id);
...
function update_question(req, title, text, category_id, sub_category_id){
    Question.findById( req.params.id, function ( err, question ){
//        if(is_full(title))          { question.title    = title; }
//        if(is_full(text))           { question.text    = text; }
//        if(is_full(category_id))    { question.text    = category_id; }
//        if(is_full(sub_category_id)){ question.text    = sub_category_id; }
        if(question !== undefined){
            question.save( function ( err, question, callback ){
//                callback(question);
