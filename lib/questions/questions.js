...
exports.update = function(req, callback) {
    ...
    callback(update_question(req, title, text, category_id, sub_category_id, callback));
...
function update_question(req, title, text, category_id, sub_category_id, callback){
